      ...
      <section className="bg-gradient-to-br from-rose-900 to-rose-800 text-white py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-rose-100 max-w-2xl mx-auto">
            Let&apos;s discuss how we can make your next event unforgettable
          </p>
        </div>
      </section>
          ...
          <div className="grid md:grid-cols-2 gap-12">
            ...
            <div>
              ...
              <p className="text-gray-600 mb-8">
                Have questions about our services? Ready to start planning your
              ...
              <div className="space-y-6">
                <div className="flex items-start">
                  <svg
                    className="w-6 h-6 text-rose-800 mt-1 mr-4"
                    fill="none"
                    stroke="currentColor"
                    viewBox="0 0 24 24"
                  >
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">Available throughout the region</p>
                  </div>
                </div>
              </div>
            </div>
